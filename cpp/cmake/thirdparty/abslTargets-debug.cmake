...
set_target_properties(absl::log_severity PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_log_severity${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::log_severity )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::log_severity "${_IMPORT_PREFIX}/lib/absl_log_severity${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::raw_logging_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_raw_logging_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::raw_logging_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::raw_logging_internal "${_IMPORT_PREFIX}/lib/absl_raw_logging_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::spinlock_wait PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_spinlock_wait${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::spinlock_wait )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::spinlock_wait "${_IMPORT_PREFIX}/lib/absl_spinlock_wait${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::malloc_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_malloc_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::malloc_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::malloc_internal "${_IMPORT_PREFIX}/lib/absl_malloc_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::base PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_base${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::base )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::base "${_IMPORT_PREFIX}/lib/absl_base${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::throw_delegate PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_throw_delegate${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::throw_delegate )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::throw_delegate "${_IMPORT_PREFIX}/lib/absl_throw_delegate${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::exponential_biased PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_exponential_biased${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::exponential_biased )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::exponential_biased "${_IMPORT_PREFIX}/lib/absl_exponential_biased${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::periodic_sampler PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_periodic_sampler${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::periodic_sampler )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::periodic_sampler "${_IMPORT_PREFIX}/lib/absl_periodic_sampler${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::scoped_set_env PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_scoped_set_env${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::scoped_set_env )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::scoped_set_env "${_IMPORT_PREFIX}/lib/absl_scoped_set_env${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::strerror PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_strerror${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::strerror )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::strerror "${_IMPORT_PREFIX}/lib/absl_strerror${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::hashtablez_sampler PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_hashtablez_sampler${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::hashtablez_sampler )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::hashtablez_sampler "${_IMPORT_PREFIX}/lib/absl_hashtablez_sampler${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::raw_hash_set PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_raw_hash_set${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::raw_hash_set )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::raw_hash_set "${_IMPORT_PREFIX}/lib/absl_raw_hash_set${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::stacktrace PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_stacktrace${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::stacktrace )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::stacktrace "${_IMPORT_PREFIX}/lib/absl_stacktrace${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::symbolize PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_symbolize${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::symbolize )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::symbolize "${_IMPORT_PREFIX}/lib/absl_symbolize${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::examine_stack PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_examine_stack${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::examine_stack )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::examine_stack "${_IMPORT_PREFIX}/lib/absl_examine_stack${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::failure_signal_handler PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_failure_signal_handler${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::failure_signal_handler )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::failure_signal_handler "${_IMPORT_PREFIX}/lib/absl_failure_signal_handler${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::debugging_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_debugging_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::debugging_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::debugging_internal "${_IMPORT_PREFIX}/lib/absl_debugging_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::demangle_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_demangle_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::demangle_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::demangle_internal "${_IMPORT_PREFIX}/lib/absl_demangle_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::leak_check PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_leak_check${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::leak_check )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::leak_check "${_IMPORT_PREFIX}/lib/absl_leak_check${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::leak_check_disable PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_leak_check_disable${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::leak_check_disable )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::leak_check_disable "${_IMPORT_PREFIX}/lib/absl_leak_check_disable${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_program_name PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_program_name${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_program_name )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_program_name "${_IMPORT_PREFIX}/lib/absl_flags_program_name${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_config PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_config${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_config )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_config "${_IMPORT_PREFIX}/lib/absl_flags_config${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_marshalling PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_marshalling${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_marshalling )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_marshalling "${_IMPORT_PREFIX}/lib/absl_flags_marshalling${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_commandlineflag_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_commandlineflag_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_commandlineflag_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_commandlineflag_internal "${_IMPORT_PREFIX}/lib/absl_flags_commandlineflag_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_commandlineflag PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_commandlineflag${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_commandlineflag )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_commandlineflag "${_IMPORT_PREFIX}/lib/absl_flags_commandlineflag${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_private_handle_accessor PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_private_handle_accessor${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_private_handle_accessor )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_private_handle_accessor "${_IMPORT_PREFIX}/lib/absl_flags_private_handle_accessor${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_reflection PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_reflection${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_reflection )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_reflection "${_IMPORT_PREFIX}/lib/absl_flags_reflection${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_internal "${_IMPORT_PREFIX}/lib/absl_flags_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags "${_IMPORT_PREFIX}/lib/absl_flags${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_usage_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_usage_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_usage_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_usage_internal "${_IMPORT_PREFIX}/lib/absl_flags_usage_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_usage PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_usage${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_usage )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_usage "${_IMPORT_PREFIX}/lib/absl_flags_usage${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::flags_parse PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_flags_parse${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::flags_parse )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::flags_parse "${_IMPORT_PREFIX}/lib/absl_flags_parse${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::hash PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_hash${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::hash )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::hash "${_IMPORT_PREFIX}/lib/absl_hash${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::city PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_city${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::city )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::city "${_IMPORT_PREFIX}/lib/absl_city${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::wyhash PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_wyhash${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::wyhash )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::wyhash "${_IMPORT_PREFIX}/lib/absl_wyhash${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::int128 PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_int128${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::int128 )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::int128 "${_IMPORT_PREFIX}/lib/absl_int128${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_distributions PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_distributions${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_distributions )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_distributions "${_IMPORT_PREFIX}/lib/absl_random_distributions${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_seed_gen_exception PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_seed_gen_exception${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_seed_gen_exception )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_seed_gen_exception "${_IMPORT_PREFIX}/lib/absl_random_seed_gen_exception${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_seed_sequences PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_seed_sequences${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_seed_sequences )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_seed_sequences "${_IMPORT_PREFIX}/lib/absl_random_seed_sequences${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_internal_seed_material PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_internal_seed_material${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_internal_seed_material )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_internal_seed_material "${_IMPORT_PREFIX}/lib/absl_random_internal_seed_material${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_internal_pool_urbg PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_internal_pool_urbg${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_internal_pool_urbg )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_internal_pool_urbg "${_IMPORT_PREFIX}/lib/absl_random_internal_pool_urbg${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_internal_platform PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_internal_platform${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_internal_platform )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_internal_platform "${_IMPORT_PREFIX}/lib/absl_random_internal_platform${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_internal_randen PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_internal_randen${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_internal_randen )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_internal_randen "${_IMPORT_PREFIX}/lib/absl_random_internal_randen${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_internal_randen_slow PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_internal_randen_slow${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_internal_randen_slow )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_internal_randen_slow "${_IMPORT_PREFIX}/lib/absl_random_internal_randen_slow${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_internal_randen_hwaes PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_internal_randen_hwaes${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_internal_randen_hwaes )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_internal_randen_hwaes "${_IMPORT_PREFIX}/lib/absl_random_internal_randen_hwaes${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_internal_randen_hwaes_impl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_internal_randen_hwaes_impl${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_internal_randen_hwaes_impl )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_internal_randen_hwaes_impl "${_IMPORT_PREFIX}/lib/absl_random_internal_randen_hwaes_impl${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::random_internal_distribution_test_util PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_random_internal_distribution_test_util${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::random_internal_distribution_test_util )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::random_internal_distribution_test_util "${_IMPORT_PREFIX}/lib/absl_random_internal_distribution_test_util${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::status PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_status${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::status )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::status "${_IMPORT_PREFIX}/lib/absl_status${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::statusor PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_statusor${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::statusor )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::statusor "${_IMPORT_PREFIX}/lib/absl_statusor${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::strings PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_strings${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::strings )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::strings "${_IMPORT_PREFIX}/lib/absl_strings${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::strings_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_strings_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::strings_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::strings_internal "${_IMPORT_PREFIX}/lib/absl_strings_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::str_format_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_str_format_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::str_format_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::str_format_internal "${_IMPORT_PREFIX}/lib/absl_str_format_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::cord PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_cord${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::cord )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::cord "${_IMPORT_PREFIX}/lib/absl_cord${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::graphcycles_internal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_graphcycles_internal${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::graphcycles_internal )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::graphcycles_internal "${_IMPORT_PREFIX}/lib/absl_graphcycles_internal${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::synchronization PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_synchronization${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::synchronization )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::synchronization "${_IMPORT_PREFIX}/lib/absl_synchronization${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::time PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_time${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::time )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::time "${_IMPORT_PREFIX}/lib/absl_time${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::civil_time PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_civil_time${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::civil_time )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::civil_time "${_IMPORT_PREFIX}/lib/absl_civil_time${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::time_zone PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_time_zone${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::time_zone )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::time_zone "${_IMPORT_PREFIX}/lib/absl_time_zone${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::bad_any_cast_impl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_bad_any_cast_impl${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::bad_any_cast_impl )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::bad_any_cast_impl "${_IMPORT_PREFIX}/lib/absl_bad_any_cast_impl${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::bad_optional_access PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_bad_optional_access${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::bad_optional_access )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::bad_optional_access "${_IMPORT_PREFIX}/lib/absl_bad_optional_access${CMAKE_STATIC_LIBRARY_SUFFIX}" )
...
set_target_properties(absl::bad_variant_access PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/absl_bad_variant_access${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )

list(APPEND _IMPORT_CHECK_TARGETS absl::bad_variant_access )
list(APPEND _IMPORT_CHECK_FILES_FOR_absl::bad_variant_access "${_IMPORT_PREFIX}/lib/absl_bad_variant_access${CMAKE_STATIC_LIBRARY_SUFFIX}" )
